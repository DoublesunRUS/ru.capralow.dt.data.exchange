...
public class DataExchangeUiPlugin extends AbstractUIPlugin {
	public static final String ID = "ru.capralow.dt.data.exchange.plugin.ui"; //$NON-NLS-1$
	private static DataExchangeUiPlugin plugin;
	...
	public static DataExchangeUiPlugin getDefault() {
		return plugin;
	}
