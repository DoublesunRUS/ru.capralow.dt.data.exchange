...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Dep Project Status</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see ru.capralow.dt.data.exchange.plugin.core.dep.model.depPackage#getDepProjectStatus()
 * @model
 * @generated
 */
public enum DepProjectStatus implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Dep Project Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DepProjectStatus[] VALUES_ARRAY =
		new DepProjectStatus[] {
			NO_CONFIGURATION,
			NO_SUBSYSTEM,
			NO_SSL_VERSION,
			NO_COMMON_MODULE,
	...
	/**
	 * A public read-only list of all the '<em><b>Dep Project Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DepProjectStatus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Dep Project Status</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DepProjectStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DepProjectStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dep Project Status</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static DepProjectStatus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DepProjectStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dep Project Status</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DepProjectStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DepProjectStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
